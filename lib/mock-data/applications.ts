...
export const mockApplications: Application[] = [
  // Application 1: Sarah Johnson - 60% complete (IN PROGRESS - being filled out by applicant/broker)
  {
    id: "app-1",
    buildingId: "bldg-1",
  ...
  // Application 2: Michael Chen - SUBMITTED by broker, awaiting Transaction Agent review
  {
    id: "app-2",
    buildingId: "bldg-2",
  ...
  // Application 3: Emily Rodriguez - IN_REVIEW by Board (submitted by Transaction Agent)
  {
    id: "app-3",
    buildingId: "bldg-3",
  ...
  // Application 4: James Thompson - SUBMITTED by broker, awaiting Transaction Agent review
  {
    id: "app-4",
    buildingId: "bldg-4",
  ...
  // Application 5: Amanda Martinez - IN_REVIEW by Board (submitted by Transaction Agent)
  {
    id: "app-5",
    buildingId: "bldg-5",
  ...
  // Application 6: Robert Kim - 100% complete (ready for broker to submit)
  {
    id: "app-6",
    buildingId: "bldg-6",
  ...
  // Application 7: Lisa Anderson - SUBMITTED by broker, awaiting Transaction Agent review
  {
    id: "app-7",
    buildingId: "bldg-7",
