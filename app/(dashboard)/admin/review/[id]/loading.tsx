  ...
  return (
    <div className="flex h-[calc(100vh-4rem)] flex-col">
      ...
      <div className="flex flex-1 overflow-hidden">
        {/* Left Column */}
        <div className="w-1/4 min-w-[250px] max-w-[350px] border-r p-4">
        ...
        <div className="flex-1 border-r p-6">
          <div className="space-y-4">
            ...
            {[1, 2, 3].map((i) => (
              <div key={i} className="h-24 w-full animate-pulse rounded border bg-gray-50" />
            ))}
          </div>
        </div>
        ...
        <div className="w-1/4 min-w-[300px] max-w-[400px] p-4">
          <div className="h-full w-full animate-pulse rounded border bg-gray-50" />
        </div>
      </div>
    </div>
  )
