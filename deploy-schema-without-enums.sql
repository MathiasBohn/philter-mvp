-- =====================================================
-- Philter MVP Database Schema - Modified for Existing Enums
-- Skips enum creation since they already exist
-- =====================================================
...
CREATE INDEX IF NOT EXISTS idx_applications_transaction_type ON applications(transaction_type);

-- People
CREATE INDEX IF NOT EXISTS idx_people_application ON people(application_id);
CREATE INDEX IF NOT EXISTS idx_people_role ON people(role);

-- Employment
CREATE INDEX IF NOT EXISTS idx_employment_person ON employment_records(person_id);

-- Financial entries
CREATE INDEX IF NOT EXISTS idx_financial_person ON financial_entries(person_id);
CREATE INDEX IF NOT EXISTS idx_financial_type ON financial_entries(entry_type);

-- Real estate
CREATE INDEX IF NOT EXISTS idx_real_estate_person ON real_estate_properties(person_id);
...
-- RFIs
CREATE INDEX IF NOT EXISTS idx_rfis_application ON rfis(application_id);
CREATE INDEX IF NOT EXISTS idx_rfis_status ON rfis(status);

-- Application participants
CREATE INDEX IF NOT EXISTS idx_participants_application ON application_participants(application_id);
CREATE INDEX IF NOT EXISTS idx_participants_user ON application_participants(user_id);
...
DO $$ 
BEGIN
  RAISE NOTICE 'Schema created successfully! Enums already existed.';
END $$;
